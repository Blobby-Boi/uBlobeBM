setTimeout(() => {
    ...
    async function getublobelocalstorage(key) {
        ...
        const script = localstorageWindow.document.createElement('script');
        script.textContent = `
